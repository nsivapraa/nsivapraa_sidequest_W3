...
// 1) drawRegular() → what the screen looks like
...
function drawRegular() {
  ...
  drawChoiceButton(regBtn1);
  drawChoiceButton(regBtn2);

  // ---- Cursor feedback ----
  // If the mouse is over the button, show a hand cursor
  // Otherwise, show the normal arrow cursor
  const over = isHover(regBtn1) || isHover(regBtn2);
