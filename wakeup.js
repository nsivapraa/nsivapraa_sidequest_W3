...
// 1) drawWakeup() → what the screen looks like
...
const wakeBtn2 = {
  ...
  w: 260, // width
  h: 90, // height
  label: "Make breakfast", // text shown on the button
};
// ------------------------------
...
function drawWakeup() {
  ...
  textSize(18);
  text(
    "You're wake up and check the time--you're late! You have two choices:",
    width / 2,
    210,
  );
